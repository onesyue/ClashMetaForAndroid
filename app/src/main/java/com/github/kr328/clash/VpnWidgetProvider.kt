...
class VpnWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        private const val ACTION_TOGGLE = "com.github.kr328.clash.action.WIDGET_TOGGLE"

        fun refreshAllWidgets(context: Context) {
            val manager = AppWidgetManager.getInstance(context)
            val component = ComponentName(context, VpnWidgetProvider::class.java)
        ...
        private fun updateWidget(
            ...
            val views = RemoteViews(context.packageName, DesignR.layout.widget_vpn_status)
